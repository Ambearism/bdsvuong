                                ...
                                <Card className="border-slate-200 bg-white">
                                    ...
                                    <CardContent className="p-3 space-y-2">
                                        {c.linkedProperties.map(p => (
                                            <div
                                                key={p.id}
                                                className="flex items-center justify-between p-3 rounded-xl border border-slate-100 hover:border-indigo-200 transition-colors group cursor-pointer"
                                                onClick={() => window.dispatchEvent(new CustomEvent('routeChange', { detail: { route: 'property_hub', id: p.id } }))}
                                            >
                                                <div>
                                ...
                                <Card className="border-slate-200 bg-white">
                                    ...
                                    <CardContent className="p-3 space-y-2">
                                        {c.linkedLeases.map(l => (
                                            <div
                                                key={l.id}
                                                className="flex items-center justify-between p-3 rounded-xl border border-indigo-50 bg-indigo-50/30 hover:border-indigo-300 transition-colors group cursor-pointer"
                                                onClick={() => window.dispatchEvent(new CustomEvent('routeChange', { detail: { route: 'lease_hub', id: l.id } }))}
                                            >
