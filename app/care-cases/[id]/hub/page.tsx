...
import { getCareCaseHub, updateCareCaseStatus } from '../../../../data/careFactory';
        ...
        <div className="animate-in fade-in slide-in-from-right-4 duration-500 space-y-6">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <div className="flex gap-2">
                    ...
                    <Button className="gap-2 shadow-lg shadow-indigo-100 font-bold bg-indigo-600"><Zap size={18}/> Chỉnh sửa Case</Button>
                </div>
            </div>
                ...
                <div className="w-full lg:w-[320px] space-y-6">
                    ...
                    <Card className="border-slate-200 shadow-sm bg-white overflow-hidden">
                        ...
                        <CardContent className="p-5">
                            ...
                            <Button variant="outline" className="w-full mt-4 h-9 text-[10px] font-black uppercase tracking-wider border-slate-200">Điều chỉnh mức phí</Button>
                        </CardContent>
                    </Card>
                    ...
                    <div className="p-5 bg-amber-50 border border-amber-200 rounded-2xl flex items-start gap-4 shadow-sm">
                        ...
                        <div>
                            <p className="text-xs font-black text-amber-900 uppercase tracking-wider mb-1">Ghi chú VIP</p>
                            <p className="text-[11px] text-amber-800 leading-relaxed font-medium">
                                Cần ưu tiên các yêu cầu bảo trì định kỳ và gửi báo cáo thuế hàng quý đúng hạn cho chủ nhà.
                            </p>
                        </div>
                    </div>
                </div>
