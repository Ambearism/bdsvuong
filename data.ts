...
import { DashboardData, DetailedFilterState, FilterState, FunnelStage, InventoryCategory, InventoryDetailedItem, KPIItem, Lead, LeadDashboardData, LeadFilterState, LeadSource, RevenueData, Deal, DealDashboardData, DealFilterState, DealStage, PipelineCard, PipelineStageKey } from './types';

// Base data
const kpiBase: KPIItem[] = [
  { id: '1', label: 'Lead Tiềm Năng', value: 450, changeValue: '+15.2%', changeType: 'positive', tooltip: 'Tổng số lead mới trong kỳ' },
  { id: '2', label: 'Deal Đang Xử Lý', value: 158, changeValue: '+12 Deals', changeType: 'positive', tooltip: 'Các giao dịch đang trong giai đoạn đàm phán/cọc' },
  { id: '3', label: 'Giao Dịch Thành Công', value: 18, changeValue: '+2 Giao Dịch', changeType: 'positive', tooltip: 'Đã ký hợp đồng mua bán/thuê' },
  { id: '4', label: 'Doanh Số Giao Dịch', value: 98.5, unit: 'tỷ', changeValue: '+8.2 tỷ', changeType: 'positive', tooltip: 'Tổng giá trị hợp đồng thực tế' },
  { id: '5', label: 'Giá Trị Giỏ Hàng (Tổng)', value: 5850, unit: 'tỷ', changeValue: '-1.2%', changeType: 'neutral', tooltip: 'Tổng giá trị BĐS đang mở bán/thuê' },
  { id: '6', label: 'Tỷ Lệ Chốt (Conversion)', value: 4.0, unit: '%', changeValue: '↗ 0.2%', changeType: 'positive', tooltip: 'Tỷ lệ từ Lead -> Giao Dịch thành công' },
];
...
const sourceBase: LeadSource[] = [
  { name: 'Facebook Ads', value: 180, deals: 5, color: '#3b82f6' },
  { name: 'Google Search', value: 120, deals: 6, color: '#ef4444' },
...
export const generatePipelineData = (): PipelineCard[] => {
    return Array.from({ length: 60 }, (_, i) => {
        ...
        return {
            ...
            notes: Math.random() > 0.6 ? ["Khách hẹn gọi lại", "Quan tâm căn hướng Đông"] : [],
            tasks: Math.random() > 0.7 ? [{
                id: `task-${i}`, 
                title: "Gửi báo giá", 
                assigneeName: "Trịnh Trung Hiếu", 
                // Fix: added missing required 'assignee' property to match the TaskItem type definition.
                assignee: "user_1",
