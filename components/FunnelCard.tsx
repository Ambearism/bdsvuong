  ...
  return (
    <Card className="h-full overflow-hidden bg-white relative">
      <CardHeader className="flex flex-row items-center justify-between">
        <CardTitle>Tiến Trình Khách → Cơ hội → G.Dịch</CardTitle>
        <div className="text-slate-400" title="Biểu đồ phễu chuyển đổi"><Info size={16} /></div>
      </CardHeader>

      <CardContent className="relative w-full aspect-[16/9] min-h-[500px]">
        <svg
                  ...
                  {isRightSide ? (
                    <>
                      ...
                      <text x={xRightEdge + 70} y={geo.yCenter} dominantBaseline="middle" className="text-xs">
                        ...
                        <tspan x={xRightEdge + 70} dy="1.4em" className="fill-slate-500 font-medium">{formatNumber(stage.count)} Khách</tspan>
                      </text>
                    </>
                  ) : (
                    <>
                      ...
                      <text x={xLeftEdge - 70} y={geo.yCenter} dominantBaseline="middle" textAnchor="end" className="text-xs">
                        ...
                        <tspan x={xLeftEdge - 70} dy="1.4em" className="fill-slate-500 font-medium">{formatNumber(stage.count)} Khách</tspan>
                      </text>
                    </>
                  )}
                </g>
