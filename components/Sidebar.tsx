...
const MENU_ITEMS: MenuItem[] = [
  ...
  { section: 'KINH DOANH' },
  {
    ...
    subItems: [
      ...
      { id: 'deals', label: 'Danh sách Giao dịch' },
  ...
  { icon: BarChart3, id: 'report_properties', label: 'Báo cáo Hàng hóa', onClick: (route: string) => window.dispatchEvent(new CustomEvent('routeChange', { detail: 'reports/hang-hoa' })) },
  { icon: PieChart, id: 'report_performance', label: 'Báo cáo Hiệu suất', onClick: (route: string) => window.dispatchEvent(new CustomEvent('routeChange', { detail: 'reports/sales-performance' })) },
  { divider: true },

  { section: 'QUẢN TRỊ HỆ THỐNG' },
  { icon: UserCog, id: 'staff', label: 'Tài khoản nhân viên' },
  { icon: Shield, id: 'permissions', label: 'Phân quyền & Vai trò' },
  { divider: true },

  { section: 'CÀI ĐẶT & HỆ THỐNG' },
  { icon: Settings, id: 'settings', label: 'Cấu hình hệ thống' },
  { icon: LayoutPanelLeft, id: 'footer_settings', label: 'Cấu hình Footer' },
