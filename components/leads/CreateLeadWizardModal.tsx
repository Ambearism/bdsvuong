...
const STEPS = [
    { id: 1, label: "Thông tin Khách & Liên hệ" },
    { id: 2, label: "Nhu cầu BĐS" },
    { id: 3, label: "Nguồn Khách & phân bổ" },
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4 animate-in fade-in duration-200">
            <div className="bg-white w-full max-w-[1000px] h-[95vh] md:h-auto md:max-h-[90vh] rounded-2xl shadow-2xl flex flex-col overflow-hidden">
                ...
                <div className="flex items-center justify-between px-6 py-4 border-b border-slate-100 bg-white">
                    <div>
                        <h2 className="text-xl font-bold text-slate-800">Tạo Khách Mới</h2>
                        ...
                        <form onSubmit={(e) => e.preventDefault()} className="space-y-6">
                            ...
                            {step === 3 && (
                                <div className="space-y-6 animate-in slide-in-from-right-4 duration-300">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <Select label="Trạng thái" required value={formData.status} onChange={v => handleChange('status', v)} error={errors.status} options={[{value:'lead_moi', label:'Khách Mới'}, {value:'dang_cham', label:'Đang Chăm'}, {value:'hen_xem_nha', label:'Hẹn Xem Nhà'}]} />
                                    ...
                                    {['hen_xem_nha', 'deal_mo', 'dam_phan'].includes(formData.status) && (
                                        <div className="flex items-start gap-3 p-4 bg-amber-50 text-amber-800 rounded-xl border border-amber-100 text-sm">
                                            ...
                                            <div>
                                                <span className="font-bold">Lưu ý:</span> Bạn đang chọn trạng thái <b>"{formData.status === 'hen_xem_nha' ? 'Hẹn Xem Nhà' : 'Giao dịch Mở'}"</b>. 
