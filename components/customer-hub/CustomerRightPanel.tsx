        ...
        <Card className="shadow-sm border-slate-200 overflow-hidden">
            ...
            <CardContent className="pt-10 px-6 pb-6 space-y-4">
                ...
                <div className="flex flex-wrap gap-2 pt-2">
                    ...
                    <Badge variant="warning" className="bg-amber-50 text-amber-700 border-amber-100 text-[10px]">2 Khách đang chăm</Badge>
                </div>
            </CardContent>
        </Card>
        ...
        <Card className="shadow-sm border-slate-200">
            ...
            <CardContent className="p-2 space-y-1">
                ...
                <button onClick={() => onTabChange('leads_deals')} className="w-full flex items-center justify-between p-3 rounded-lg hover:bg-slate-50 transition-colors group text-left">
                    <span className="text-sm font-medium text-slate-700 flex items-center gap-2"><Tag size={16} className="text-amber-500"/> Khách / Giao dịch</span>
                    <div className="flex items-center gap-2">
