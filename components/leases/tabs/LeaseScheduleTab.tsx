    ...
    <div className="space-y-6">
        <div className="flex flex-col sm:flex-row justify-between items-center gap-4 px-1">
            ...
            <div className="flex gap-2">
                <Button variant="outline" size="sm" className="bg-white border-slate-200 text-slate-600 h-9 font-bold"><History size={14} className="mr-2"/> Đối soát nhanh</Button>
                <Button variant="primary" size="sm" className="h-9 gap-2 shadow-md"><Plus size={14}/> Thêm kỳ hạn</Button>
            </div>
        </div>
