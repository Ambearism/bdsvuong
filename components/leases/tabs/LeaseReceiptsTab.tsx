        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Card className="bg-white border-slate-200 p-5 flex gap-4 items-start shadow-sm rounded-2xl">
                ...
                <div className="text-xs">
                    <p className="font-black text-slate-900 mb-1 uppercase tracking-widest">Chứng từ hợp lệ</p>
                    <p className="text-slate-500 font-medium leading-relaxed">Phiếu thu đã đối soát ngân hàng và đính kèm UNC được coi là chứng từ kế toán đủ điều kiện.</p>
                </div>
            </Card>
            <Card className="bg-white border-slate-200 p-5 flex gap-4 items-start shadow-sm rounded-2xl">
