...
export const LeaseDetailsSidebar = ({ lease }: { lease: Lease }) => {
    ...
    return (
        <div className="w-full lg:w-[320px] shrink-0 space-y-6">
            ...
            <div className="px-2">
                <button className="w-full py-3 px-4 rounded-xl border border-dashed border-slate-300 text-slate-500 text-xs font-bold hover:border-indigo-400 hover:text-indigo-600 transition-all">
