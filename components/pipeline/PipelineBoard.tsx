...
const STAGE_CONFIG: { key: PipelineStageKey; title: string; color: string }[] = [
    { key: 'lead_moi', title: 'LEAD MỚI', color: 'emerald' },
    { key: 'dang_cham', title: 'ĐANG CHĂM', color: 'amber' },
    { key: 'hen_xem_nha', title: 'HẸN XEM NHÀ', color: 'orange' },
    { key: 'deal_mo', title: 'DEAL MỞ', color: 'rose' },
    { key: 'dam_phan', title: 'ĐÀM PHÁN', color: 'indigo' },
    { key: 'dat_coc', title: 'ĐẶT CỌC', color: 'sky' },
    { key: 'gd_hoan_tat', title: 'GD HOÀN TẤT', color: 'teal' },
    { key: 'that_bai', title: 'THẤT BẠI', color: 'slate' },
];
