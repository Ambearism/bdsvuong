        ...
        <div className="fixed inset-0 z-[60] flex justify-end">
             ...
             <div className="relative w-full max-w-[400px] h-full bg-white shadow-2xl flex flex-col animate-in slide-in-from-right-10 duration-300 border-l border-slate-200">
                ...
                <div className="p-4 border-t border-slate-100 bg-slate-50 flex gap-3">
                    <Button variant="outline" className="flex-1 gap-2 text-xs" onClick={() => toast("Mở chi tiết Lead")}>
                        <ExternalLink size={14} /> Mở Lead
                    </Button>
                    {card.hasDeal && (
                        <Button variant="primary" className="flex-1 gap-2 text-xs" onClick={() => toast("Mở chi tiết Deal")}>
                            <Briefcase size={14} /> Mở Deal
                        </Button>
                    )}
                </div>
             </div>
