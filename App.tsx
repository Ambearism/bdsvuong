...
import ProjectCreatePage from './app/projects/create/page';
...
import PermissionsPage from './app/settings/permissions/page';
import InventoryReportPage from './app/reports/hang-hoa/page';
import SalesPerformanceReportPage from './app/reports/sales-performance/page';
...
const App = () => {
  ...
  const renderContent = () => {
    switch (currentRoute) {
      ...
      case 'project_create': return <ProjectCreatePage />;
      case 'project_edit': return <ProjectEditPage params={{ id: currentEntityId! }} />;
      ...
      // Reports
      case 'reports/hang-hoa': return <InventoryReportPage />;
      case 'reports/sales-performance': return <SalesPerformanceReportPage />;
